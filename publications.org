...
** In preparation
1. *Hill, Spencer A.* and Natalie J. Burls.  "Mechanisms of poleward energy
...
1. *Hill, Spencer A.*, Simona Bordoni, and Jonathan L. Mitchell.  "Influence of
   ...
   cell theory."  Submitted to /Journal of the Atmospheric Sciences/.
   {{{LINK("papers/had-cell-trop-depth_2col.pdf", PDF.)}}}
** Peer-reviewed
1. (2019) *Hill, Spencer A.* "Theories for past and future monsoon rainfall
   changes."  Accepted, /Current Climate Change Reports/.
   {{{LINK("papers/hill-2019-monsoons-review-accepted.pdf", PDF.)}}}
