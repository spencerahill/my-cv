...
1. *Hill, Spencer A.* "CQE, MSE, ITCZ, or all three? On theories of monsoon
   rainfall and its response to climate change."  Under review, /Current Climate
   Change Reports/.  {{{LINK("papers/hill-2019-monsoons-review.pdf", PDF.)}}}
2. *Hill, Spencer A.*, Simona Bordoni, and Jonathan L. Mitchell.  "Constraints
   from axisymmetric theory on the positions of the cross-equatorial Hadley cell
   edges."  In revision, /Journal of the Atmospheric Sciences/.
