...
\label{sec:orgccf7503}
\href{mailto:shill@atmos.ucla.edu}{shill@gps.caltech.edu}\\
...
cell theory."  Under review for \emph{Journal of the Atmospheric Sciences}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:orgd94f487}
\begin{enumerate}
...
\label{sec:orgacdef64}
\subsection*{"DIYnamics" project}
\label{sec:org0f12667}
...
\label{sec:org680e32d}
\subsection*{Invited}
\label{sec:org2eef9d1}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
