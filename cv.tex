...
\label{sec:orgf61718a}
\begin{enumerate}
\item \textbf{Hill, Spencer A.} "CQE, MSE, ITCZ, or all three? On theories of monsoon
rainfall and its response to climate change."  Revised for \emph{Current Climate
Change Reports}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:org4bbda2a}
\begin{enumerate}
...
\label{sec:orgf492e7d}
\subsection*{"DIYnamics" project}
\label{sec:orgef87512}
