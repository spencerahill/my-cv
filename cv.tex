...
\label{sec:org1c4bb2d}
\begin{enumerate}
\item \textbf{Hill, Spencer A.} "CQE, MSE, ITCZ, or all three? On theories of monsoon
rainfall and its response to climate change."  Submitted to \emph{Current Climate
Change Reports}.
...
\label{sec:org40631d7}
\subsection*{"DIYnamics" project}
\label{sec:org15f5e51}
...
\label{sec:orgcffa9ef}
\subsection*{Invited}
\label{sec:org2b1f423}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
