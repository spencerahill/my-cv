...
\section*{Education}
\label{sec:org48f98b3}
\subsection*{Graduate | Princeton University}
\label{sec:org04e2ff3}
...
\label{sec:orgaafbd9d}
\subsection*{In preparation}
\label{sec:orgd4c85dd}
\begin{enumerate}
