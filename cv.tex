...
\label{sec:org9a8e718}
\begin{enumerate}
\item Jeevanjee, Nadir, Pedram Hassanzadeh, \textbf{Spencer A. Hill}, and Aditi Sheshadri.
"A perspective on climate model hierarchies."  In revision at \emph{Journal of
...
\label{sec:org40d0615}
\begin{center}
\begin{tabularx}{\textwidth}{rX}
06/2016 & Chair, \href{https://ams.confex.com/ams/21Fluid19Middle/webprogram/Session43327.html}{"Idealized approaches to the atmospheric and oceanic circulation, Part II"} session, AMS 21st Conference on Atmospheric and Oceanic Fluid Dynamics, Portland, OR\\
...
\label{sec:org5593ba3}
\subsection*{"DIYnamics" project}
\label{sec:org5732989}
