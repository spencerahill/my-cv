...
\usepackage{amssymb}
\usepackage{capt-of}
\usepackage[colorlinks=true,linkcolor=gray,citecolor=gray]{hyperref}
...
\label{sec:org6585c21}
\subsection*{Current position}
\label{sec:org1fe90e2}
...
\label{sec:org6113d23}
AOS/Applied Mathematics double major | Conferred June 2011 |
Magna Cum Laude | Phi Beta Kappa | UCLA College Honors
\section*{Publications}
\label{sec:org07f922d}
\subsection*{Submitted/under review/in revision}
\label{sec:orgae21a32}
\begin{enumerate}
\item \textbf{Hill, Spencer A.}, Simona Bordoni, and Jonathan L. Mitchell.  "Dynamical
constraints on the solsticial Hadley Cell ascending edge in Earth's
macroturbulent atmosphere."  Under review, \emph{Journal of the Atmospheric
Sciences}.  \url{https://arxiv.org/abs/2011.05966}.
...
\label{sec:org4e2fca1}
\subsection*{"DIYnamics" project}
\label{sec:orgce1f941}
\subsubsection*{Overview}
\label{sec:org0f63f31}
...
\label{sec:org4a679d9}
\subsection*{Overview}
\label{sec:org2319195}
...
\label{sec:org1d4c877}
\subsection*{Invited}
\label{sec:orgff31daa}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
