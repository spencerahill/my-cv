...
\date{}
\title{Postdoctoral Research Fellow | Columbia University}
\hypersetup{
 pdfauthor={Spencer Alan Hill, Ph.D.},
 pdftitle={Postdoctoral Research Fellow | Columbia University},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:org53e4759}
\subsection*{Current position}
\label{sec:org6983186}
...
cell theory."  In revision for \emph{Journal of the Atmospheric Sciences}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:org2af7634}
\begin{enumerate}
\item (2019) \textbf{Hill, Spencer A.} "Theories for past and future monsoon rainfall
changes."  In press, \emph{Current Climate Change Reports}.  doi:
...
\label{sec:orgb273480}
\subsection*{"DIYnamics" project}
\label{sec:org076f1a6}
...
\begin{itemize}
\item UCLA press release: \url{http://newsroom.ucla.edu/releases/a-50-do-it-yourself-device-designed-at-ucla-makes-science-fun-for-students-of-all-ages}
...
\label{sec:orge71425d}
\subsection*{Invited}
\label{sec:org48b0ca9}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
