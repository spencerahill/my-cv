...
\label{sec:org8dd5914}
\begin{enumerate}
\item \textbf{Hill, Spencer A.} "CQE, MSE, ITCZ, or all three? On theories of monsoon
rainfall and its response to climate change."  In revision, \emph{Current Climate
Change Reports}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:org234d7ef}
\begin{enumerate}
\item (2019) \textbf{Hill, Spencer A.}, Simona Bordoni, and Jonathan L. Mitchell.
"Axisymmetric constraints on cross-equatorial Hadley cell extent."  Accepted,
\emph{Journal of the Atmospheric Sciences}.
...
\label{sec:org48daced}
\subsection*{"DIYnamics" project}
\label{sec:org494d3f6}
...
\label{sec:orgdd5ec84}
\subsection*{Invited}
\label{sec:org2a79e1d}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
