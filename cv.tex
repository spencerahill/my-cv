...
\label{sec:orgddac877}
\subsection*{"DIYnamics" project}
\label{sec:org9fd154b}
...
\label{sec:org408fa32}
\subsection*{Invited}
\label{sec:orgb319a48}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
...
\label{sec:org5023725}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
\textit{[2019-06-25 Tue]} & (planned) "Modernizing Axisymmetric Hadley Cell and Monsoon Theory"  Oral.  AMS 22nd Conference on Atmospheric and Oceanic Fluid Dynamics.  Portland, ME.\\
