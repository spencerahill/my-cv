...
submission to \emph{Current Climate Change Reports}.
...
Aurnou.  "Affordable rotating fluid demonstrations for geoscience education:
The \emph{DIYnamics} project."  In revision, \emph{Bulletin of the American
Meteorological Society}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:org5ce4978}
\begin{enumerate}
...
\label{sec:org9f511d4}
\subsection*{"DIYnamics" project}
\label{sec:orgb003847}
