...
Under review, \emph{Journal of the Atmospheric Sciences}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:orgab01888}
\begin{enumerate}
...
Holocene orbital forcing."  Accepted, \emph{Geophysical Research Letters}.  doi:
\href{https://doi.org/10.1029/2018GL080494}{10.1029/2018GL080494}.
...
\label{sec:org3a2c0bd}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
(planned) \textit{[2018-11-13 Tue]} & "The general circulation of the atmosphere."  UCLA AOS 200A: Introduction to Atmospheric and Oceanic Fluid  (graduate level)\\
(planned) \textit{[2018-11-15 Thu]} & "Simple theoretical models of the Hadley cells."  UCLA AOS 200A: Introduction to Atmospheric and Oceanic Fluid  (graduate level)\\
\end{tabularx}
\end{center}
\section*{Public Outreach}
\label{sec:orga18f441}
\subsection*{"DIYnamics" project}
\label{sec:org4ddb52b}
