...
demonstrations."  Submitted to \emph{Bulletin of the American Meteorological
Society}.
\item Smyth, Jane, \textbf{Spencer A. Hill}, and Yi Ming.  "Simulated responses of the West
African monsoon and zonal-mean tropical precipitation to early Holocene
orbital forcing."  Submitted to \emph{Geophysical Research Letters}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:org933bae1}
\begin{enumerate}
...
\end{enumerate}
\subsection*{Software}
\label{sec:org1e7465f}
\begin{enumerate}
\item (2017) \textbf{Hill, Spencer A.} and Spencer Clark.  "aospy: automated climate data
...
\label{sec:org2c42b01}
\subsection*{"DIYnamics" project}
\label{sec:orgeeafd39}
