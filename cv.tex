...
\label{sec:org4dc07c7}
\subsection*{Current position}
\label{sec:orga7243e8}
...
of the Hadley Cell."  In preparation for submission to \emph{Geophysical Research
Letters}.
\end{enumerate}
\subsection*{Submitted/under review/in revision}
\label{sec:orgc3b0764}
\begin{enumerate}
...
\label{sec:orgaa257a2}
\subsection*{"DIYnamics" project}
\label{sec:org9ffbdbe}
\subsubsection*{Overview}
\label{sec:org4fa6c74}
...
\label{sec:org3a34c6c}
\subsection*{Invited}
\label{sec:orgaeb6c11}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
