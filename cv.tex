...
\label{sec:org19d6bf2}
\subsection*{Current position}
\label{sec:orgdecfebd}
...
\label{sec:orged70045}
\begin{enumerate}
\item \textbf{Hill, Spencer A.}, Simona Bordoni, and Jonathan L. Mitchell.  "Axisymmetric
Hadley Cell theory with a fixed tropopause temperature rather than height."
Revised for \emph{Journal of the Atmospheric Sciences}.
\item Mitchell, Jonathan L. and \textbf{Spencer A. Hill}.  "Combining Thermodynamic and
Dynamic Perspectives of Tropical Circulation to Constrain the Downdraft Width
of the Hadley Cell."  Under review, \emph{Geophysical Research Letters}.  arXiv:
\href{http://arxiv.org/abs/1911.05860}{http://arxiv.org/abs/1911.05860}.
\end{enumerate}
\subsection*{Peer-reviewed}
\label{sec:orgecb03be}
\begin{enumerate}
...
\href{https://doi.org/10.1007/s40641-019-00137-8}{10.1007\%2Fs40641-019-00137-8}.  Online access: \url{https://rdcu.be/bHFCZ}.
...
\label{sec:orgd1f3a8e}
\subsection*{"DIYnamics" project}
\label{sec:org7887e1b}
\subsubsection*{Overview}
\label{sec:org8dae18a}
...
\label{sec:org4afd1a1}
\subsection*{Overview}
\label{sec:org8908afa}
...
\label{sec:orgbe56343}
\begin{itemize}
\item Documentation: \url{https://aospy.readthedocs.io}
\item Source code: \url{https://github.com/spencerahill/aospy}
\end{itemize}
\section*{Reviewing}
\label{sec:org4874870}
\begin{itemize}
\item Proposal reviewer for National Science Foundation and NASA Juno Participating
Scientist Program
\item Article reviewer for \emph{Nature Climate Change}, \emph{Journal of Climate}, \emph{Quarterly
Journal of the Royal Meteorological Society}, \emph{Geophysical Research Letters},
\emph{Journal of the Atmospheric Sciences}, \emph{Geoscientific Model Development},
\emph{Climatic Change}, \emph{Climate Dynamics}, \emph{Journal of Geophysical Research -
Atmospheres}, and GFDL internal manuscript review.
\end{itemize}

\section*{Presentations}
\label{sec:org5337a15}
\subsection*{Invited}
\label{sec:orgaf80aaf}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
...
\textit{[2019-12-10 Tue]} & (planned) "Toward an analytical, predictive theory for the location of Hadley and monsoonal cell ascending branches."  Invited conference talk.  American Geophysical Union Fall Meeting.  San Francisco, CA.\\
...
\label{sec:org72c8eba}
\begin{center}
\begin{tabularx}{\textwidth}{lX}
\textit{[2019-12-10 Tue]} & (planned) "Simulated polar amplification and its causes on decadal to millennial timescales."  Poster.  AGU Fall Meeting.  San Francisco, CA.\\
