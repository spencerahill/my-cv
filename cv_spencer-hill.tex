...
Room 214B & & 207B Oceanography \\
NOAA Geophysical Fluid Dynamics Laboratory & & Lamont-Doherty Earth Observatory \\
201 Forrestal Road & & 61 Route 9W \\
Princeton, NJ 08540 & & Palisades, NY 10964 \\
(609) 452-5302 & & (913) 515-8527 \\
\href{mailto:spencerh@princeton.edu}{spencerh@princeton.edu} & & \href{mailto:shill@ldeo.columbia.edu}{shill@ldeo.columbia.edu} \\
&&\href{https://www.ldeo.columbia.edu/~shill}{https://www.ldeo.columbia.edu/\~{}shill}
\end{tabular}
...
2023- & Assistant Professor, \dept/ of Earth and Atmospheric Sciences, City College of New York (to commence \aug/ 25th)\\
...
2021 & ``How do energy fluxes link precipitation variability across the tropical weather-climate continuum?'' Principal Investigator.  3 yr, \$682,038.  NSF Climate and Large-Scale Dynamics.\\
...
Byrne MP, G Hegerl, J. Scheff, \ldots, \textbf{SA Hill}, et al. ``Theory and the future of land-climate science.''  Submitted, \emph{Nature Climate Change}.\\
Zurita-Gotor P, IM Held, TM Merlis, CY Chang, \textbf{SA Hill}, CG MacDonald.  ``Non-uniqueness in ITCZ latitude due to radiation-circulation coupling in an idealized GCM.''  In revision, \emph{Journal of Advances in Modeling Earth Systems}.\\
Biasutti M, M Ting, \textbf{SA Hill}. ``The world’s monsoons: dynamics and change.''  In revision, \emph{Physics Today}.\\
\end{longtable}

\subsection*{Refereed journal articles}
\begin{longtable}{@{} Y{0.05\textwidth} >{\color{black}} p{0.04\textwidth} @{} L{0.91\textwidth} @{}}
2023 & 20. & Moscoso JE, RE Tripoli, S Chen, H Gonzalez, \textbf{SA Hill}, N Khoo, TL Lonner, JM Aurnou. ``Low-cost table-top experiments for teaching
multi-scale geophysical fluid dynamics.''  Accepted, \emph{Frontiers in Marine Science}. doi:  \href{https://doi.org/10.3389/fmars.2023.1192056}{10.3389/fmars.2023.1192056}.\\
     & 19. & Ahmed F, JD Neelin, \textbf{SA Hill}, K Schiro, and H Su. ``A process model for ITCZ narrowing under warming highlights clear-sky water vapor feedbacks and gross moist stability changes in AMIP models.'' Accepted, \emph{J. Climate}.  doi: \href{https://doi.org/10.1175/JCLI-D-22-0689.1}{10.1175/JCLI-D-22-0689.1}.\\
...
\section*{ADVISING}
\subsection*{Graduate students, as co-advisor}
\begin{longtable}{@{}  Y{0.05\textwidth} L{0.95\textwidth} @{}}
2022- & Alexander Parsells, \dept/ of Earth and Environmental Sciences, Columbia University\\
\end{longtable}


\subsection*{Undergraduate students, as primary advisor}
\begin{longtable}{@{}  Y{0.05\textwidth} L{0.95\textwidth} @{}}
...
\subsection*{Undergraduate summer interns at NOAA GFDL, as co-advisor}
\begin{longtable}{@{}  Y{0.05\textwidth} L{0.95\textwidth} @{}}
2023 & (planned) Kittson Hamill\\
2022 & Rea Restugi\\
2015 & Jane Smyth\\
2014 & Marjahn Finlayson\\
2013 & Colin Raymond
\end{longtable}
\vskip1em
...
\subsection*{Courses}
\begin{longtable}{@{} Y{0.1\textwidth} L{0.9\textwidth} @{}}
2023 Fall & CCNY EAS 42000 (planned) ``Statistical Methods in Earth and Atmospheric Sciences.''\\
\end{longtable}
...
2015- & Volunteer at 10+ science outreach events at schools or open to the public\\
...
% Since these started in 2021ish, literally zero output has come from these, after considerable time, so I think it's more appropriate to omit them.
% Special Topic Editor, ``Regional Variability of the Tropical Rain Belt in a Changing Climate,'' \emph{Frontiers in Climate}\\
